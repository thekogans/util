...
template <std::size_t Target, bool my_check> struct long_double_alignment{ typedef long double type; };
template <std::size_t Target> struct long_double_alignment<Target, false>{ typedef boost::detail::max_align type; };

template <std::size_t Target, bool my_check> struct double_alignment{ typedef double type; };
...
#ifndef BOOST_NO_LONG_LONG
template <std::size_t Target, bool my_check> struct long_long_alignment{ typedef boost::long_long_type type; };
...
template <std::size_t Target, bool my_check> struct long_alignment{ typedef long type; };
#ifndef BOOST_NO_LONG_LONG
...
template <std::size_t Target, bool my_check> struct int_alignment{ typedef int type; };
...
template <std::size_t Target, bool my_check> struct short_alignment{ typedef short type; };
...
template <std::size_t Target, bool my_check> struct char_alignment{ typedef char type; };
