...
namespace thekogans {
    namespace util {
        ...
        struct _LIB_THEKOGANS_UTIL_DECL FileAllocator :
            ...
            /// serialization machinery defined in \see{RandomSeekSerializer} and
            /// \see{Serializer}. BlockBuffer is also flexible enough to provide
            /// access to sub ranges. Making it efficient to update only the parts
