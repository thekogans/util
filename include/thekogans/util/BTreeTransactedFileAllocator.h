...
#if !defined (__thekogans_util_BTreeTransactedFileAllocator_h)
#define __thekogans_util_BTreeTransactedFileAllocator_h
...
namespace thekogans {
    namespace util {
        ...
        /// \struct BTreeTransactedFileAllocator BTreeTransactedFileAllocator.h
        /// thekogans/util/BTreeTransactedFileAllocator.h
        ///
        /// \brief
        /// BTreeTransactedFileAllocator manages a heap on permanent storage.
        /// The heap physical layout looks like this:
        struct _LIB_THEKOGANS_UTIL_DECL BTreeTransactedFileAllocator :
            ...
            public:
                ...
                /// \brief
                /// Read the block.
                virtual void Read (TransactedFile &file) override;
                /// \brief
                /// Write the block.
                virtual void Write (TransactedFile &file) const override;
            };
        ...
        private:
            ...
            struct _LIB_THEKOGANS_UTIL_DECL Header : public Allocator::Header {
                /// \brief
                ...
                Header (ui16 flags = 0,
                        PtrType heapStart = SIZE) :
                        Allocator::Header (flags, heapStart),
                        btreeOffset (0),
        ...
        private:
            ...
            /// \brief
            /// BTreeTransactedFileAllocator is neither copy constructable, nor assignable.
            THEKOGANS_UTIL_DISALLOW_COPY_AND_ASSIGN (BTreeTransactedFileAllocator)
        };

    } // namespace util
} // namespace thekogans

#endif // !defined (__thekogans_util_BTreeTransactedFileAllocator_h)
