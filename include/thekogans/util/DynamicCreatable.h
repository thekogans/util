...
namespace thekogans {
    namespace util {
        ...
        ///     // If bar happens to be a template.
        ///     THEKOGANS_UTIL_IMPLEMENT_DYNAMIC_CREATABLE_BASE_T (foo::bar<some type>)
        ///
        /// } // namespace foo
        /// \endcode
        ///
        ...
        struct _LIB_THEKOGANS_UTIL_DECL DynamicCreatable : public DynamicCreatableBase {
            ...
            /// \brief
            /// Declare DynamicCreatable BasesSize.
            THEKOGANS_UTIL_DECLARE_DYNAMIC_CREATABLE_BasesSize (DynamicCreatable)
            /// \brief
