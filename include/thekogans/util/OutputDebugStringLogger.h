...
namespace thekogans {
    namespace util {
        ...
        /// \struct OutputDebugStringLogger OutputDebugStringLogger.h thekogans/util/OutputDebugStringLogger.h
        ///
        /// \brief
        ...
        struct _LIB_THEKOGANS_UTIL_DECL OutputDebugStringLogger : public Logger {
            ...
            OutputDebugStringLogger (ui32 level = UI32_MAX) :
                Logger (level) {}
...
#endif // !defined (__thekogans_util_OutputDebugStringLogger_h)
