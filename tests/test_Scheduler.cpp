...
void TestQueueRecyclingHighFrequency() {
    ...
    std::thread bombardier([&scheduler, &stopBombardment]() {
        ...
        Scheduler::JobQueue::SharedPtr streamQueue = new Scheduler::JobQueue(scheduler, Scheduler::JobQueue::PRIORITY_NORMAL, "StreamQueue");
    ...
    for (int i = 0; i < targetCycles; ++i) {
        ...
        Scheduler::JobQueue* temporaryQueue = new Scheduler::JobQueue(scheduler, Scheduler::JobQueue::PRIORITY_HIGH, "TempQueue");
